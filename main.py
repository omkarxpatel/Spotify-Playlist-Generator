...
from user_secrets import username, clientID, clientSecret, redirectURI
...
def playSong(spotifyObject, searchQuery):
    ...
    openSong = input("Woudl you like to open this song in your browser [yes/no]: ").lower()
